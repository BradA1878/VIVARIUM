...
| [superpowers/specs/2026-09-26-pressure-network-design.md](superpowers/specs/2026-09-26-pressure-network-design.md) | Spec: the pressure network — every hub a root, docked modules, auto-laid corridors with a ghost preview, `offReason` with fault badges, HUD fault lines, and the network overlay. |
